...
<body data-color="theme-1">
	...
	<div class="container">
						...
						<form class="f-login-form">
								...
								<div class="input-entry color-3">
									<input class="checkbox-form" id="text-1" type="checkbox"
										...
										class="clearfix" for="text-1"> <span class="sp-check"><i
											class="fa fa-check"></i></span> <span class="checkbox-text">Register
											now</span>
									</label>
								</div>
								<div class="input-entry color-3">
									<input class="checkbox-form" id="text-2" type="checkbox"
										...
										class="clearfix" for="text-2"> <span class="sp-check"><i
											class="fa fa-check"></i></span> <span class="checkbox-text">Remember
											me</span>
									</label>
								</div>
							</div>
							...
							<div class="row">
								<div class="col-xs-12 col-sm-6">
									<a href="#" class="c-button full b-60 bg-blue-7 hv-blue-7-o"><i
										class="fa fa-facebook"></i><span>login via facebook</span></a>
								</div>
								<div class="col-xs-12 col-sm-6">
									<a href="#" class="c-button full b-60 bg-blue-8 hv-blue-8-o"><i
										class="fa fa-twitter"></i><span>login via facebook</span></a>
								</div>
							</div>
		...
		<div class="full-copy">© 2015 All rights reserved.
			let’stravel</div>
	</div>
