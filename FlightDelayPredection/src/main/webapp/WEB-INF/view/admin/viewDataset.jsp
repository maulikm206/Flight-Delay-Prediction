		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Dataset</h4>
							<div class="row">
								<div class="col-12">
											...
											<tbody>
												<c:forEach items="${datasetList}" var="i" varStatus="j">
													<tr>
														...
														<td><a
															href="<%=request.getContextPath()%>/docs/dataset/${i.datasetFileName}"
															target="blank" download><i class="mdi mdi-attachment"  style="font-size:30px"></i></a></td>
														<td><a href="editDataset?datasetId=${i.datasetId}"><i
																style="font-size: 20px; margin-left: 15px;"
																class="mdi mdi-pencil-box-outline"></i></a> <a
															href="deleteDataset?datasetId=${i.datasetId}"><i
