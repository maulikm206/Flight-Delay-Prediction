							...
							<div class="card">
								<div class="card-body">
									...
									<f:form class="cmxform" id="commentForm" method="post"
										onsubmit="return addAirport()" action="saveAirport"
										modelAttribute="AirportVO">
										<fieldset>
											...
											<div class="form-group">
												<f:select class="form-control" name="cityName" id="cityName"
													path="cityVO.cityId">
													<option selected="selected" value="none">Select
														City Name</option>
											...
											<div class="form-group">
												<label for="cname">Airport Name</label>
												<f:input path="airportName" id="airportName"
													class="form-control" name="airportName" minlength="2"
													type="text" placeholder="Enter Airport Name" />
											</div>

											<div class="form-group">
												<label for="ccomment">Airport Description</label>
												<f:textarea path="airportDescription"
													id="airportDescription" class="form-control"
													name="airportDescription"
													placeholder="Enter airport Description"></f:textarea>
											</div>

											<f:hidden path="airportId" />
