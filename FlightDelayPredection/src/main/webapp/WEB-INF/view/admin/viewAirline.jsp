...
<title>Admin | View Airline</title>
<!-- plugins:css -->
<link rel="stylesheet"
		...
		<div class="container-fluid page-body-wrapper">
			...
			<div class="main-panel">
				<div class="content-wrapper">
					<div class="card">
						<div class="card-body">
							<h4 class="card-title">View Airline</h4>
							<div class="row">
								<div class="col-12">
										...
										<table id="order-listing" class="table">
											...
											<tbody>
												...
												<tr>
													...
													<td><a href="editAirline?airlineId=${i.airlineId}"><i
															style="font-size: 20px; margin-left: 15px;"
															class="mdi mdi-pencil-box-outline"></i></a> <a href="deleteAirline?airlineId=${i.airlineId}"><i
